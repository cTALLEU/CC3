...
code suivant pour essayer de ne sélectionner que quelques lignes du tableua et donc ne pas utiliser les éponges prélevés une seule fois 
```{r}
samples.out <- rownames(seqtab.nochim)
...
On va maitenant faire une pCoA (indice de beta diversite). Les points vont êtres places les uns en fonction des autres. On ajoute donc des relations.
...
```{r}
plot(0,2:0,3,type="n",xlab="Abundance of Species 1",
