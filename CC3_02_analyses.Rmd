...
```
```{r}
heatmap.2(as.matrix(data.prop),Rowv = as.dendrogram(row.clus), Colv = as.dendrogram(col.clus), distfun = dist,  hclustfun = hclust,  reorderfun = reorder.dendrogram, symm = FALSE,  col = scaleyellowred, RowSideColors = var1 
```
